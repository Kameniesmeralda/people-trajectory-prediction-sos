# people-trajectory-prediction-sos
Projet de recherche académique dans un apprentissage profond pour la prédiction des trajectoires humaines en utilisant les principes des systèmes autoorganisés (SOS) / Academic Research Project in Deep Learning for Human Trajectory Prediction Using the Principles of Self-Organizing Systems (SOS)
...
Description rapide de l'approche (Boids + PSO)
